...
# the response message that indicates that
# the user's account was successfully verified
WIDTHDRAW_REQUEST_CREATED_SUCCESS: dict[str, str] = {
    "success": "widthdraw_request_created"
}
...
REGISTER_SUCCESS_TITLE: str = "Thank you for registering with MariaMi"
REGISTER_SUCCESS_TEXT: str = "You received this message because this email is registered in the MariaMi app."
...
PASS_UPDATE_SUCCESS_TEXT: str = (
    "You received this message because your password has been changed in MariaMi."
)

EMAIL_MESSAGE_TEMPLATE_TITLE: str = "{type} {key} in the MariaMi app"
...
ACCOUNT_DELETE_SUCCESS_TEXT: str = "You received this message because your account has been deleted in the MariaMi app."

TEMPLATE_SUCCESS_BODY_TITLE: str = "Change {key} passed successfully"
TEMPLATE_SUCCESS_TITLE: str = "Your {key} changed!"
TEMPLATE_SUCCESS_TEXT: str = "You received this message because your {key} has been changed in the MariaMi application."

EMAIL_VERIFY_SUCCESS_BODY_TITLE: str = "Verification was successful!"
EMAIL_VERIFY_SUCCESS_TEXT: str = "You received this message because your account has been verified in the MariaMi application."
